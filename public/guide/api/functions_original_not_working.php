...
function getCatgories() 
{
	...
	if(mysqli_num_rows($sel)){
		...
		$cat_id=$row['id'];  
			$sel3=mysqli_query($con,"SELECT c.eng_phrase,c.lug_phrase1, c.filename, c.filepath, c.originalfilename FROM  phrase c WHERE c.categoryid='$cat_id' ORDER BY ordering ASC")or die(mysqli_error($con));
