...
<div class="box box-info"> 
  ...
  <div class="box-body">
      <div class="row">
        <div class="col-xs-4">
          {{ Form::text('thedate', $thedate, ['class' => 'form-control', 'id' => 'routedate']) }}
        </div>
        <div class="col-xs-4">
          {{ Form::select('bikeid', $bikes, $bikeid, ['class' => 'form-control']) }}
        </div>
        <div class="col-xs-4">
          {{ Form::select('transporterid', $transporters, $tranpsorterid, ['class' => 'form-control']) }}
        </div>
      </div>
       ...
       <div class="row">
        <div class="col-xs-4">
          ...
          {{ Form::select('facilityid', $facilitydropdown, $facilityid, ['class' => 'form-control']) }}
        </div>
        <div class="col-xs-8">
          <h2>Reason(s)</h2>
