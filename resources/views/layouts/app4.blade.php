    ...
    <section class="content-header">
      <h1>
       ...
       <ul class="list-inline context-menu">
        <li><a href="{{route('new')}}"><i class="fa fa-home"></i> Dashboard</a></li>
        <li><a class="" href="{{ route('contact.comprehensive_list') }}" target="_blank">Contacts</a></li>
