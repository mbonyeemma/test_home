...
<div class="box box-info">
  <div class="well firstrow list">
    <div class="row">
      {{ Form::open(array('route' => 'hubsampl.data', 'class' => 'form-search pull-left', 'id' => 'samplelist')) }}
            {{ csrf_field() }}
        ...
        @endrole
        <button type="submit" id="searchbutton" class="btn btn-primary">Export To Excel <i class="glyphicon glyphicon-filter"></i></button>
        {{ Form::close() }}  
    </div>
  </div>
