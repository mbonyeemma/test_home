...
<div class="well firstrow list">
          <div class="row">
            <div class="col-md-12"> {{ Form::open(array('route' => 'samples.all', 'class' => 'form-search pull-left', 'id' => 'samplelist')) }}
              {{ csrf_field() }}
  ...
  <div class="box-body no-padding">
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
          <li class="{{$tab_1_class}}"><a href="{{ route('samples.all') }}?page_type=1#tab_1" data-toggle="link" aria-expanded="true">Individual Tracking</a></li>
          <li class="{{$tab_2_class}}"><a href="{{ route('samples.all') }}?page_type=2#tab_2" data-toggle="link" aria-expanded="false">Batch Tracking</li>
