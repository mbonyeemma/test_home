...
<script>
  $(document).ready(function() {
    ...
    $.ajax({
      type: 'GET',
      url: "<?php echo e(url('sampletracking/late_delivery')); ?>",
      success: function(data) {
    ...
    $.ajax({
      type: 'GET',
      url: "<?php echo e(url('sampletracking/covid_stats/2')); ?>",
      success: function(data) {
        $('#deliverd').html(data);
      }
    });
    $.ajax({
      type: 'GET',
      url: "<?php echo e(url('sampletracking/covid_stats/3')); ?>",
      success: function(data) {
        $('#received').html(data);
      }
    });
    $.ajax({
      type: 'GET',
      url: "<?php echo e(url('sampletracking/covid_stats/1')); ?>",
      success: function(data) {
...
<div class="well firstrow list">
  <div class="row">
    <div class="col-md-12"> <?php echo e(Form::open(array('route' => 'home', 'class' => 'form-search pull-left', 'id' => 'samplelist'))); ?>

      <?php echo e(csrf_field()); ?>

      <?php echo e(Form::hidden('page_type', $page_type)); ?>

      <?php echo e(Form::text('from', $from, ['class' => 'input-field filter-date', 'id' => 'from', 'placeholder' => 'From'])); ?>


      <?php echo e(Form::text('to', $to, ['class' => 'input-field filter-date', 'id' => 'to', 'placeholder' => 'To'])); ?>


      <?php echo e(Form::select('facilityid', $facilities, $request->facilityid, ['class'=>'select2 selectdropdown autosubmitsearchform'])); ?>

      <?php echo e(Form::select('poe', $poes, $request->poe, ['class'=>'select2 selectdropdown autosubmitsearchform'])); ?>

      <?php echo e(Form::select('ref_lab', $ref_labs, $request->ref_lab, ['class'=>'select2 selectdropdown autosubmitsearchform'])); ?>

      <?php echo e(Form::select('site_type', $site_types, $request->site_type, ['class'=>'select2 selectdropdown autosubmitsearchform'])); ?>

      <?php echo e(Form::select('test_type', $test_types, $request->test_type, ['class'=>'select2 selectdropdown autosubmitsearchform'])); ?>
  ...
  <div class="box-body no-padding">
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs">
        <li class="<?php echo e($tab_1_class); ?>"><a href="<?php echo e(route('home')); ?>?page_type=1#tab_1" data-toggle="link" aria-expanded="true">Individual Tracking</a></li>
        <li class="<?php echo e($tab_2_class); ?>"><a href="<?php echo e(route('home')); ?>?page_type=2#tab_2" data-toggle="link" aria-expanded="false">Batch Tracking</li>
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="tab_<?php echo e($tab); ?>">
            ...
            <table id="listtable" class="table table-striped table-bordered">
              <thead>
                <tr>
                  ...
                  <th>Collection Point Facility</th>
                  <th>District</th>
                  <th>Hub</th>
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    <?php if($tab == 1): ?>
                    <a href="#" data-id="<?php echo e($sample->container); ?>" class="sample_display" onclick="getPackageSamples(<?php echo e($sample->id); ?>)"><?php echo e($sample->container); ?></a>
                    <?php else: ?>
                    <?php echo e($sample->container); ?>

                    <?php endif; ?>
                  </td>
                  <td class="hidden"><a href="#" data-id="<?php echo e($sample->id); ?>" class="sample_display" onclick="trace_sample(<?php echo e($sample->id); ?>)"><?php echo e($sample->sample_id); ?></a></td>
                  <!-- <td><?php echo e($sample->collection_point); ?></td> -->
                  <td><?php echo e($sample->collection_point_name); ?></td>
                  <td><?php echo e($sample->district); ?></td>
                  <td><?php echo e($sample->hub); ?></td>
                  <td><?php echo e($sample->final_destn); ?></td>
                  <td><?php echo e($sample->testtype); ?></td>
                  <td><?php echo e($sample->numberofsamples); ?></td>
                  <td><?php echo e($sample->date_picked); ?></td>
                  <td>
                    <?php if($sample->status == 4): ?>
                    Referred
                    <?php elseif($sample->final_destination == $sample->location && $sample->status == 3): ?>
                    Received
                    <?php elseif($sample->final_destination == $sample->location && $sample->status == 2): ?>
                    Delivered
                    <?php elseif($sample->status == 0): ?>
                    Waiting for pickup
                    <?php else: ?>
                    In Transit
                    <?php endif; ?>
                  </td>
                  <td><?php echo e($sample->last_seen); ?></td>
                  <td><?php echo e($sample->last_seen_facility); ?></td>
                  <td><?php echo e($sample->delivered_on); ?></td>
                  <td><?php if($sample->final_destn == $sample->last_seen_facility && $sample->status == 3): ?>
                    <?php echo e($sample->last_seen); ?>

                    <?php else: ?>

                    <?php endif; ?>
                  </td>
                  <td><?php echo e(getPublicTAT($sample->date_picked,$sample->last_seen,$sample->final_destination,$sample->location,$sample->destination,$sample->status)); ?></td>
                </tr>
