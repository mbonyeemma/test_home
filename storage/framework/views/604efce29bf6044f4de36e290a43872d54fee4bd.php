                                        ...
                                        <div class="card card-body">
                                            <div class="box-body table-responsive">
                                                <table id="tracking" class="table table-striped table-sm">
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $files_2024; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><?php echo e($file); ?></td>
                                                            <td><a href="<?php echo e(asset('dataarchives/2024')); ?>/<?php echo e($file); ?>" target="_blank"> Download</a> </td>
                                                        </tr>
                                        ...
                                        <div class="card card-body">
                                            <div class="box-body table-responsive">
                                                <table id="tracking_2023" class="table table-striped table-sm">
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $files_2023; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><?php echo e($file); ?></td>
                                                            <td><a href="<?php echo e(asset('dataarchives/2023')); ?>/<?php echo e($file); ?>" target="_blank"> Download</a> </td>
                                                        </tr>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="card card-body">
                                            <div class="box-body table-responsive">
                                                <table id="tracking_2022" class="table table-striped table-sm">
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $files_2022; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><?php echo e($file); ?></td>
                                                            <td><a href="<?php echo e(asset('dataarchives/2022')); ?>/<?php echo e($file); ?>" target="_blank"> Download</a> </td>
                                                        </tr>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="card card-body">
                                            <div class="box-body table-responsive">
                                                <table id="tracking_2021" class="table table-striped table-sm">
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $files_2021; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><?php echo e($file); ?></td>
                                                            <td><a href="<?php echo e(asset('dataarchives/2021')); ?>/<?php echo e($file); ?>" target="_blank"> Download</a> </td>
                                                        </tr>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </tbody>
                                                </table>
