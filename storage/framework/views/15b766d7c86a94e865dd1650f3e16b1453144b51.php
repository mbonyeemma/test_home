...
<!-- <?php echo $__env->make('index.leftband1', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> -->
    ...
    <section class="content-header">
      <h1>
       ...
       <ul class="list-inline context-menu">
        <li><a href="<?php echo e(route('new')); ?>"><i class="fa fa-home"></i> Dashboard</a></li>
        <li><a class="" href="<?php echo e(route('contact.comprehensive_list')); ?>" target="_blank">Contacts</a></li>
