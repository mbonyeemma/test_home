...
<div class="well firstrow list">
    <div class="row">
        <div class="col-md-12">
            <?php echo e(Form::open(array('route' => 'new', 'class' => 'form-search pull-left', 'id' => 'samplelist'))); ?>

            <?php echo e(csrf_field()); ?>

            <?php echo e(Form::text('from', Request::get('from') , ['class' => 'input-field filter-date', 'id' => 'from', 'placeholder' => $firstDate])); ?>

            <?php echo e(Form::text('to', Request::get('to'), ['class' => 'input-field filter-date', 'id' => 'to', 'placeholder' => $cur_date])); ?>

            <?php echo e(Form::select('region', $regions, Request::get('region'),['class'=>'select2 selectdropdown autosubmitsearchform','id'=>'pop_region'])); ?>

            <?php echo e(Form::select('district', $districts, null,['class'=>'select2 selectdropdown','id'=>'district'])); ?>

            <?php echo e(Form::select('hubid', $hubs, Request::get('hubid'),['class'=>'select2 selectdropdown autosubmitsearchform','id'=>'hub'])); ?>
...
<span class='label label-primary label-bs'>
    <strong>
        <?php echo e(('From').' '.$from_set.' '.('To').' '.$to_set); ?>
...
<div class="panel panel-primary" style="margin-top: 20px;">
    <div class="panel-body">
        <ul class="nav nav-tabs">
            ...
            <!-- <li>
                <a href="#5" data-toggle="tab"><b><?php echo e($total_hubs_not_tracking); ?> HUBS </b><br>HUBS NOT TRACKING</a>
            </li> -->
            <li>
        ...
        <div class="tab-content ">
                                        ...
                                        <div class="card card-body">
                                            <div class="box-body table-responsive">
                                                <table id="tracking" class="table table-striped table-sm">
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $data_hubs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><?php echo e($value->hubname); ?></td>
                                                            <td><?php echo e($value->tFacility); ?> </td>
                                                            <td><?php echo e($value->dsttrkt); ?></td>
                        ...
                        <table id="nottrackingtable" class="table table-striped table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($value->tFacility); ?></td>
                                    <td><?php echo e($value->Nvisits); ?></td>
                                    <td><?php echo e(round(($value->Nvisits / $value->tFacility) * 100, 1)); ?></td>
                                    <td><?php echo e($value->region); ?></td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
            ...
            <div class="tab-pane" id="3">
                <div class="panel-body" style="overflow-x:auto;">
                    <!--  Filter Here
                <?php echo e(Form::select('hubid', $hubs, null,['class'=>'select2 selectdropdown autosubmitsearchform'])); ?> 
                    ...
                    <div class="card card-body">
                        <table id="listtable" class="table table-condensed table-sm">
                            <thead>
                                <tr>
                                    <th>Sample Type</th>
                                    <?php $__currentLoopData = $x_axis_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $months): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <th><?php echo e(returnFormatedDate($months->month_created)); ?></th>               
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                              
                                </tr>
                            </thead>
                            <tbody>
                ...
                <div class="card card-body">
                    <div class="box-body table-responsive">
                        <table id="compatcphl" class="table table-striped table-sm">
                            ...
                            <tbody>
                                <!-- <?php $__currentLoopData = $tracked_at_cphl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tracked): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($tracked->HubName); ?></td>
                                    <td><?php echo e($tracked->District); ?></td>
                                    <td><?php echo e($tracked->region); ?></td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> -->
                                <?php $__currentLoopData = $not_tracking; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($value->HubName); ?></td>
                                    <td><?php echo e($value->District); ?></td>
                                    <td><?php echo e($value->region); ?></td>
...
<!-- <script src="<?php echo e(asset('js/highchart.js')); ?>"></script> -->
<!-- <script src="<?php echo e(asset('js/exporting.js')); ?>"></script> -->
<script src="https://code.highcharts.com/modules/exporting.js"></script>
<script src="https://code.highcharts.com/modules/export-data.js"></script>
<script src="https://code.highcharts.com/modules/accessibility.js"></script>
<script src="<?php echo e(asset('js/exporting-data.js')); ?>"></script>
...
<script type="text/javascript">
    $(document).ready(function() {
        $.ajax({
            type: 'GET',
            url: "<?php echo e(url('volume/statistics')); ?>",
...
<script type="text/javascript">
    $(document).ready(function() {
        $.ajax({
            type: 'GET',
            url: "<?php echo e(url('/volume/cphl/statistics')); ?>",
            success: function(data) {
