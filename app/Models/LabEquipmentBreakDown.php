...
class LabEquipmentBreakDown extends Model {
	//specify the table to be used to store the equipment
	protected $table = "labequipmentbreakdown";
	//specify the fields that must be filled
    protected $fillable = [
        'hubid','labequipmentid','mechanicid','datebrokendown','reportingdate','brokendownenddate','status','reportedby','createdby'
    ];
