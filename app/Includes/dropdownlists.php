...
function getAllFacilitiesWitTheirhHups()
{
	...
	$facilities = \DB::select("SELECT name, id, parentid, is_ref_lab_and_hub FROM facility");
	return $facilities;
}
function getAllPoes()
{
...
function getFacilitiesforHubs($hubid)
{
	$facilities = \App\Models\Facility::pluck('name', 'id');
	return $facilities;
}
