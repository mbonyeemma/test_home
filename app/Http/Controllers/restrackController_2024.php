...
class restrackController extends Controller
{
    ...
    public function getPackagesBeyondDate($provided_date)
    {
        ...
        $query = "SELECT id, barcode, created_at FROM package WHERE delivered_on IS NULL AND created_at > '" . $provided_date . "'";
